...
csv_path = r"J:\Fotos\MyTrailStudio\20260628_153709_overlay_1s.csv"
out_path = r"J:\Fotos\MyTrailStudio\overlay_preview_tema_A_deportivo.png"
...
def load_font(size):
    candidates = [
        r"J:\Fotos\MyTrailStudio\font\font.otf",
...
if len(points) > 1:
    draw.line(points, fill=(255,255,255,120), width=3)
...
draw.ellipse((px-20, py-20, px+20, py+20), fill=(0, 255, 145, 45))
draw.ellipse((px-12, py-12, px+12, py+12), fill=(0, 255, 145, 110))
draw.ellipse((px-7, py-7, px+7, py+7), fill=accent2)
